...
1. **AI Chat (Personalized)**: Chatbot with full context of user's pets — breed, age, weight, health history, allergies, conditions. Gives personalized behavior and wellness advice, not generic answers.
...
2. **Busy Owner**: Experienced but time-constrained. Wants quick answers, product safety checks, and reminders without deep research. Values convenience and speed.
...
- **Pricing**:
  - Free: Basic profile, limited AI chat, basic health tracking
  - Plus: $2.92/mo ($34.99/year) — unlimited AI chat, product scanner, advanced insights, unlimited pets
